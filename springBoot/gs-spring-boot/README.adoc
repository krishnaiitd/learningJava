...
== Run this example for AOP check
Steps to compile and run it
1. Go to the folder `gs-spring-boot`
2. To compile
[subs="attributes"]
----
$ mvn clean compile package
----
3. Check that 8080 port is available or not by `curl localhost:8080`, if available then run the below jar on default port 8080
[subs="attributes"]
----
...
----
4. Make a curl request to check that AOP is invoked:
[subs="attributes"]
----
