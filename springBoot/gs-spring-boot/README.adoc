...
----
    ...
    {nullChecker=krishna}
    Before class: TimeTrackerAspect : String HelloController.nullChecker(String)1553610780599
    krishna
    Total milli seconds in execution of method: String HelloController.nullChecker(String) is :0
----